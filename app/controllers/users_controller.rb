class UsersController < ApplicationController
  ...
  before_action :authenticate_user! #gemのdeviseインストールによって使用できるようになったメソッド
  
  def edit
  end

  def update
    @user.update_without_password(user_params) #gemのdeviseインストールによって使用できるようになったメソッド
  ...
  private
    def set_user
      @user = current_user #gemのdeviseインストールによって使用できるようになったメソッド
    end
